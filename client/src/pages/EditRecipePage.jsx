...
const EditRecipePage = () => {
  ...
  useEffect(() => {
    ...
    fetchRecipe();
  }, [id, user._id, user.role, navigate]);
  ...
  if (fetching) return <Spinner fullScreen />;
          ...
          {imageData.url && !imagePreview ? (
            <div className="relative rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
              ...
              <button
                ...
                className="absolute bottom-3 right-3 px-3 py-1.5 bg-white/90 dark:bg-gray-800/90 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-white dark:hover:bg-gray-800 transition-colors"
              >
                Replace Image
              </button>
            </div>
